    ...
    const createElement = {
        header(key, people) {
            ...
            element.innerHTML = (`
                ...
                <h1 id="people-detail">
                    <img src="../data/img/profile.png" alt="Foto Profil" id="people-picture"/>
            ...
            uname.innerText = newName.length > 20 ? newName.substring(0, 15) + '...' : newName;
            ...
            if(currentRoom == 'private') {
                ...
                upict.setAttribute('src', people.val().photoURL || '../data/img/group.png');
                element.querySelector('#people-detail').style.cursor = 'pointer';
