            ...
            if(list.exists()) {
                ...
                list.forEach((d) => {
                    if(d.val().first == currentID || d.val().second == currentID){
                        ...
                        accEl.innerHTML = (`
                            <div class="name">
                                <img src="../data/img/profile.png" alt="name"/>
                                <div class="last-user">
                ...
                list.forEach((d) => {
                    get(ref(db, `guild/${d.key}/member/${currentID}`)).then((w) => {
                        if(w.exists()) {
                            ...
                            accEl.innerHTML = (`
                                <div class="name">
                                    <img src="../data/img/group.png" alt="name"/>
                                    <p class="username">Loading</p>
                                </div>
                                <div class="status">
                                    <p>Loading</p>
                            ...
                            accEl.querySelector(`.name img`).setAttribute('src', d.val().photoURL || '../data/img/group.png');
        ...
        get(ref(db, 'post')).then((p) => {
            ...
            if(p.exists()) {
                ...
                p.forEach((k) => {
                    ...
                    <div class="top-card">
                        <div class="left">
                            <img id="photo-sender" src="../data/img/profile.png" alt="user"/>
                    ...
                    get(ref(db, 'users/' + k.val().owner)).then((a) => {
                        ...
                        uname.length > 20  ? uname = uname.substring(0, 15) + '...' : uname = uname;
                    ...
                    commentEL.onclick = () => {
                        ...
                        <p class="comment-desk" id="comment-msg">: Lorem ipsum dolor sit amet...</p>
